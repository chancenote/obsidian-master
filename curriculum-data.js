...
// ===== DAY METADATA: difficulty (1-5), time (minutes), keyword =====
const DAY_META = {
  1:{d:1,t:40,k:'설치'},      2:{d:1,t:35,k:'마크다운'},   3:{d:2,t:40,k:'링크'},
  4:{d:2,t:35,k:'태그'},      5:{d:2,t:30,k:'검색'},       6:{d:2,t:35,k:'그래프'},
  7:{d:1,t:45,k:'PARA'},      8:{d:2,t:40,k:'플러그인'},   9:{d:3,t:50,k:'템플릿'},
  10:{d:3,t:50,k:'Dataview'}, 11:{d:4,t:60,k:'대시보드'},  12:{d:2,t:40,k:'Canvas'},
  13:{d:3,t:60,k:'확장'},     14:{d:3,t:50,k:'MOC'},       15:{d:4,t:60,k:'제텔카스텐'},
  16:{d:3,t:50,k:'콘텐츠'},   17:{d:4,t:60,k:'발행'},      18:{d:4,t:55,k:'자동화'},
  19:{d:3,t:40,k:'클리핑'},   20:{d:3,t:45,k:'동기화'},    21:{d:2,t:50,k:'점검'},
  22:{d:4,t:60,k:'Claude'},   23:{d:4,t:60,k:'일괄생성'},  24:{d:4,t:55,k:'AI글쓰기'},
  25:{d:5,t:60,k:'AI+DV'},    26:{d:5,t:60,k:'MCP'},       27:{d:3,t:50,k:'Git'},
  28:{d:5,t:60,k:'아카이브'}, 29:{d:3,t:45,k:'최적화'},    30:{d:2,t:50,k:'졸업'}
};

// ===== WEEK LEARNING OBJECTIVES =====
const WEEK_OBJECTIVES = {
  1: [
    "Obsidian 설치 및 기본 인터페이스 완전 숙지",
    "마크다운 문법으로 구조화된 노트 작성",
    "위키링크·백링크로 지식 네트워크 형성",
    "태그·YAML 메타데이터로 체계적 분류",
    "PARA 시스템 기반 Vault 구조 확립"
  ],
  2: [
    "커뮤니티 플러그인 생태계 이해 및 활용",
    "Templater로 반복 작업 자동화",
    "Dataview로 노트를 데이터베이스처럼 쿼리",
    "Canvas로 시각적 사고 및 지식맵 구축",
    "MOC(Map of Content) 시스템으로 지식 허브 구축"
  ],
  3: [
    "Zettelkasten 방법론 실전 적용",
    "아이디어→발행 콘텐츠 파이프라인 구축",
    "노트를 외부에 공유·발행하는 방법 습득",
    "웹 클리핑으로 외부 정보 자동 수집",
    "멀티 디바이스 동기화 및 백업 체계 완성"
  ],
  4: [
    "Claude Code로 Vault 자동 관리 및 노트 생성",
    "AI 기반 콘텐츠 초안 자동 생성 파이프라인",
    "대시보드·MOC 자동 갱신 시스템 구축",
    "전문 지식 아카이빙 시스템 최종 완성",
    "지속 가능한 일일·주간·월간 학습 루틴 수립"
  ]
};

// ===== ACHIEVEMENT BADGES =====
const ACHIEVEMENTS_DATA = [
  { id: 'first_step', icon: '🚀', title: '첫 발걸음', desc: 'Day 1 완료', check: (p) => !!p[1] },
  { id: 'streak_3', icon: '🔥', title: '3일 연속', desc: '3일 연속 학습', check: (p, s) => s >= 3 },
  { id: 'week1', icon: '⭐', title: '기초 마스터', desc: '1주차 완료', check: (p) => [1,2,3,4,5,6,7].every(d => p[d]) },
  { id: 'halfway', icon: '⚡', title: '절반 달성', desc: '15일 완료', check: (p) => Object.keys(p).length >= 15 },
  { id: 'week2', icon: '📚', title: '플러그인 탐험가', desc: '2주차 완료', check: (p) => [8,9,10,11,12,13,14].every(d => p[d]) },
  { id: 'streak_7', icon: '💪', title: '7일 연속', desc: '7일 연속 학습', check: (p, s) => s >= 7 },
  { id: 'week3', icon: '🧠', title: '지식 관리자', desc: '3주차 완료', check: (p) => [15,16,17,18,19,20,21].every(d => p[d]) },
  { id: 'notes_5', icon: '📝', title: '성실한 기록자', desc: '학습 노트 5개 작성', check: (p, s, n) => n >= 5 },
  { id: 'week4', icon: '🤖', title: '자동화 전문가', desc: '4주차 완료', check: (p) => [22,23,24,25,26,27,28,29,30].every(d => p[d]) },
  { id: 'master', icon: '🏆', title: '옵시디언 마스터', desc: '30일 전체 완료!', check: (p) => Object.keys(p).length >= 30 }
];
